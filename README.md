## uwsim_osgbullet (melodic) - 3.0.1-3

The packages in the `uwsim_osgbullet` repository were released into the `melodic` distro by running `/usr/local/bin/bloom-release --rosdistro melodic --track melodic uwsim_osgbullet --edit` on `Sun, 10 Nov 2019 20:13:54 -0000`
